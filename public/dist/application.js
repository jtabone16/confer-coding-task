...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'booksearch';
...
angular.module('core').config(['$sceDelegateProvider',
	function($sceDelegateProvider) {
		$sceDelegateProvider.resourceUrlWhitelist(['self', 'https://openlibrary.org/books/**']);
	},
]);
		...
		*/
		...
		$scope.getSearchResults = function (keyEvent){
			if (keyEvent.which === 13){
					...
					// 	var book = 'ISBN:' + isbn_list[i];
					// 	$scope.books.push(book);
					// }
					$http.post('/find', {'books': isbn_list}).
						then (function (res){
							console.log(res);
							if(res.config.data.hasOwnProperty('books')){
								$scope.show_error_dialog = false;
